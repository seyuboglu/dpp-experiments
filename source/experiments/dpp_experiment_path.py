...
from ppi_matrix import protein_to_node, compute_comp_scores, compute_adj_set, compute_diamond_set, compute_direct_neighborhood_scores, compute_random_walk_scores
from analysis import recall_at, recall, mean_rank, auroc, average_precision, plot_prc

OUTPUT_FILENAME = "results/dpp-comp-sqrt-qnorm.csv"
K_FOLDS = 5
...
def disease_experiment(disease): 
    ...
    for training_ids, validation_ids in generate_kfold_ids(range(len(disease_nodes)), n_splits=K_FOLDS):
        ...
        #plot_prc(labels, [(comp_scores,"Complementarity"), (dns_scores, "Direct Neighbor Scoring")], training_nodes)
